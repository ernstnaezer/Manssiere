...
namespace Manssiere.Core.Graphics.Tesselation.Tesselator
{
    ...
    public class Mesh
    {
        ...
        private readonly HalfEdge otherHalfOfThisEdgeHead = new HalfEdge(); /* and its symmetric counterpart */
        ...
        */
        ...
        public Mesh()
        {
            HalfEdge otherHalfOfThisEdge = otherHalfOfThisEdgeHead;
        ...
        */
        ...
        {
            Face fHead = faceHead;
            ContourVertex vHead = vertexHead;
            HalfEdge eHead = halfEdgeHead;
            Face f, fPrev;
            ...
            if (e.otherHalfOfThisEdge.nextHalfEdge != ePrev.otherHalfOfThisEdge
                || e.otherHalfOfThisEdge != otherHalfOfThisEdgeHead
        ...
        */
        ...
        public bool SetWindingNumber(int value, bool keepOnlyBoundary)
        {
            ...
            for (e = halfEdgeHead.nextHalfEdge; e != halfEdgeHead; e = eNext)
            {
        ...
        */
        ...
        public void DiscardExterior()
        {
            ...
            for (f = faceHead.nextFace; f != faceHead; f = next)
            {
