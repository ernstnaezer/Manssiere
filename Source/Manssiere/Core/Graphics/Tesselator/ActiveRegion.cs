 ...
 */
using DictKey = Manssiere.Core.Graphics.Tesselation.Tesselator.ActiveRegion;
...
namespace Manssiere.Core.Graphics.Tesselation.Tesselator
{
    ...
    public class ActiveRegion
    {
        ...
        {
            return upperHalfEdgeDictNode.next.Key;
        }
        ...
        {
            HalfEdge halfEdge;
            var activeRedion = new ActiveRegion();
            ...
            activeRedion.upperHalfEdgeDictNode = tess.edgeDictionary.Insert(activeRedion);
                /* __gl_dictListInsertBefore */
        }
        ...
        private static void RemoveDegenerateEdges(Tesselator tess)
        {
            ...
            for (HalfEdge currentEdge = edgeHead.nextHalfEdge; currentEdge != edgeHead; currentEdge = nextHalfEdge)
            {
                ...
                if (nextEdgeCCWAroundLeftFace.nextEdgeCCWAroundLeftFace == currentEdge)
                {
                    ...
                    {
                        if (nextEdgeCCWAroundLeftFace == nextHalfEdge ||
                            nextEdgeCCWAroundLeftFace == nextHalfEdge.otherHalfOfThisEdge)
                        {
                    ...
                    if (currentEdge == nextHalfEdge || currentEdge == nextHalfEdge.otherHalfOfThisEdge)
                    {
                        nextHalfEdge = nextHalfEdge.nextHalfEdge;
                    }
         ...
         */
        {
            IntervalHeap<ContourVertex> priorityQue = tess.vertexPriorityQue = new IntervalHeap<ContourVertex>();

            ContourVertex vertexHead = tess.mesh.vertexHead;
            for (ContourVertex curVertex = vertexHead.nextVertex;
                 curVertex != vertexHead;
