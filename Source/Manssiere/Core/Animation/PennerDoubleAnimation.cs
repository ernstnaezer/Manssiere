...
namespace Manssiere.Core.Animation
{
    using System;
    ...
    public class PennerDoubleAnimation : DoubleAnimationBase
    {
        ...
        public static readonly DependencyProperty EquationProperty =
            DependencyProperty.Register(
                ...
                new PropertyMetadata(Equations.Linear, HandleEquationChanged));
        ...
        protected override double GetCurrentValueCore(double startValue, double targetValue, AnimationClock clock)
        {
            try
            {
                ...
                var methodParams = new object[4]
                                       {
                                           clock.CurrentTime.Value.TotalSeconds, From, To - From,
        ...
        {
            var pda = sender as PennerDoubleAnimation;
        ...
        public Equations Equation
        {
            ...
            set
            {
                ...
                // cache method so we avoid lookup while animating
                _EasingMethod = GetType().GetMethod(value.ToString());
            }
        }
